  ...
  return (
    <>
      ...
      <header id="page-header" className="header">
        <div id="page-header--inner-container" className="page-content-container">
          ...
          <nav id="page-header--nav">
            ...
            <div id="page-header--nav-mobile">
              <button id="page-header--menu-icon" className="page-header--menu-icon-open">
                <div id="page-header--menu-icon-line-1" className="page-header--menu-icon-line"></div>
                <div id="page-header--menu-icon-line-2" className="page-header--menu-icon-line"></div>
                <div id="page-header--menu-icon-line-3" className="page-header--menu-icon-line"></div>
              </button>
            </div>
          </nav>
        </div>
